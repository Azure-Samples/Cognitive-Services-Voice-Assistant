...
namespace VirtualRoomApp
{
    ...
    {
        private static string connectionString = "DefaultEndpointsProtocol=https;AccountName=mynewresource;AccountKey=Ito8iNwO7ilXSh+qkrNm04d5o6vmESoqlYIHWTctmzl3+nd18Ve+zfTnZD5UtZNXDDyc374WbkAF7+gWuCoSOA==;EndpointSuffix=core.windows.net";
