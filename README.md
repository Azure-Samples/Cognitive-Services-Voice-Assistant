...
| [`clients\csharp-uwp`](https://github.com/Azure-Samples/Cognitive-Services-Voice-Assistant/tree/master/clients/csharp-uwp) |  UWP Voice Assistant Sample. Generic UWP voice agent demonstrating voice activation on Windows and Direct Line Speech. | C#, Universal Windows Platform application (UWP) |
