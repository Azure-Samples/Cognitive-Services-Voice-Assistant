...
| [`samples\clients\csharp-dotnet-core\voice-assistant-test`](https://github.com/Azure-Samples/Cognitive-Services-Voice-Assistant/tree/master/samples/clients/csharp-dotnetcore/voice-assistant-test) | Automated, multi-turn regression test and intent scoring tool. Supports WAV file input, text or Bot-Framework activities | C#, .NET Core |
