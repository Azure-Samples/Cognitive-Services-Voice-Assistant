...
namespace UWPVoiceAssistant
{
    ...
    /// </summary>
    public sealed class AgentAudioProducer
        : IDialogAudioInputProvider, IDisposable
    {
        ...
        /// <returns>Audio Graph with defaultEncoding.</returns>
        public static async Task<AgentAudioProducer> FromAgentSessionAsync(ConversationalAgentSession session)
        {
        ...
        /// <returns>Audio Graph with audio specific encoding.</returns>
        public static async Task<AgentAudioProducer> FromAgentSessionAsync(ConversationalAgentSession session, AudioEncodingProperties properties)
        {
            var result = new AgentAudioProducer()
            {
        ...
        /// </summary>
        /// <returns> A task that completes when the producer is created. </returns>
        public static async Task<AgentAudioProducer> FromNowAsync()
            => await FromAgentSessionAsync(null);
