...
1. When you first run the application, the **Setting** page will open. The first three fields are required (all others are optional):
...
The message **Press the mic button or type to start talking to your bot** will appear below the text bar if the connection succeeded.
