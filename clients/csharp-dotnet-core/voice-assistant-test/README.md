...
>>
>>##### WavFileDuration
>>` int | optional | null | 3000`. Duration of input WavFile in milliseconds.
>>
>>##### Activity
...
>>
>>##### RealTimeAudio
>>`bool | optional | null | true or false`. The default behavior of PushAudioInputStream is to send the first few seconds of audio as fast as possible to accomodate for short utterances. Following audio is throttled back to prevent client from spamming the service too fast but this throttled speed is faster than real-time microphone input. Set this optional flag to true to send audio at real-time x1 speed.
