...
Overview
===
This is a sample [UWP](https://docs.microsoft.com/en-us/windows/uwp/get-started/ "Getting Started with UWP") application developed to demonstrate proper usage of the Multi-Voice Assistant (MVA) Windows capability in conjunction with [Direct Line Speech](https://docs.microsoft.com/en-us/azure/cognitive-services/speech-service/direct-line-speech "What is Direct Line Speech?") (DLS) to create a voice agent for Windows. 

Specifically, the sample demonstrates how to use 
- MVA to launch the application with an always-on, low-power, hardware or software keyword spotter using a custom keyword
- Keyword Verification with a [Custom Keyword](https://docs.microsoft.com/en-us/azure/cognitive-services/speech-service/speech-devices-sdk-create-kws) and text-to-speech conversion with a [Custom Voice](https://docs.microsoft.com/en-us/azure/cognitive-services/speech-service/how-to-custom-voice), both from [Cognitive Speech Services](https://azure.microsoft.com/en-us/services/cognitive-services/speech-services/ "Cognitive Speech Services")
- Direct Line Speech for a voice-in, voice-out interaction with a bot developed using [Microsoft Bot Framework](https://dev.botframework.com/ "Microsoft Bot Framework")
 
 This app was designed to be a starting point for developers creating their own voice agent applications. It can be used as a set of reusable components or as an easily adaptible MVP.

Prerequisites
===
* A Limited Access Feature token issued by Microsoft.
...
cd Cognitive-Services-Voice-Assistant/MvaDls
```
...
* Click on "Voice activation setting" or, in Windows Settings, navigate to "Voice activation privacy settings". Make sure "Allow apps to use voice activation is enabled. Then, when you scroll down, there will be a list of applications. Under the entry for "MvaDlsSample", flip both toggles to enabled.
...
* Enter the Speech Key and Region associated with your Bot
...
* You can create a [Custom Voice](https://docs.microsoft.com/en-us/azure/cognitive-services/speech-service/how-to-custom-voice-create-voice) for your application's output audio. When you have created your Custom Voice, add the Custom Voice ID in the proper field in the sample app to enable it.
...
* Visit [Create Custom Wake Word](https://docs.microsoft.com/en-us/azure/cognitive-services/speech-service/speech-devices-sdk-create-kws)
* Add the .table file in the MvaDls/MvaDlsSample/SDKKeywords folder
...
* Enter the Keyword Display Name, whitelisted GUID, Language Keyword ID (1033 for en-US, 2057 for en-GB), and the bin file name in the KeywordRegistration constructor.
