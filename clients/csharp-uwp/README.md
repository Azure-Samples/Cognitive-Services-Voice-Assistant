...
- [optional] A Limited Access Feature token, issued by Microsoft, is needed if you are building, packaging, or publishing your own app to work with Windows with hardware-based keyword activation. For development purposes, the sample already contains an appropriate token.
